...
import com.rsa.securid.client.auth.Authentication;
import com.rsa.securid.client.auth.HttpBasicAuth;
import com.rsa.securid.client.auth.ApiKeyAuth;
import com.rsa.securid.client.auth.OAuth;

public class ApiClient {

    private String basePath = "https://localhost/mfa/v1_1";
    ...
    public ApiClient() {
        ...
        authentications.put("client-key", new ApiKeyAuth("header", "client-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost/mfa/v1_1
